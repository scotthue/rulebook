...
NAUCC should include at least the following event. 
...
\begin{itemize}
  ...
  \item Road Racing: 10k and Marathon, see section \ref{part:road_racing}.
   \item Muni: Cross Country, Uphill, Downhill, see part \ref{part:muni}.
   \item Freestyle: Individual, Pairs, and a group event, see part \ref{part:freestyle}.
   \item Trials, see part \ref{part:trials}.
  \item Flatland, see part \ref{part:flat-street}
  \item Team Games: Unicycle Hockey, see part \ref{part:hockey}
\end{itemize}
...
\subsection{Awards}
Because awards are paid for out of the convention budget, and are one of the major expenses of large competitions.
The type, number, and quality of awards are the choice of the convention host, but all must include both the year of the event and one or more of the following:
\begin{itemize}
...
Generally there are trophies/expert medals for ``to'' events, medals for ``subtop'' events, and ribbons for lower events or places.
...
\textbf{Geared:} A unicycle that is equipped with a ratio other than 1 pedal revolution:1 wheel revolution.
...
\textbf{USA Convention Liaison:} The Liaison is an optional person who can represent the USA Board when communicating with convention hosts.
