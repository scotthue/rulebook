...
The following age groups are the minimum required by the IUF to be offered at the time of registration for any Track \& Field discipline: 0-6 (16$"$), 0-10 (20$"$), 0-12, 13-18, 19-29, 30-UP.
For Wheel Walk, the event for 0-10 riders is a 10 meter race.
...
Wheel sizes for track racing are 20$"$, and 24$"$.
Additional groups for 16$"$ or other wheels can be added.
Age groups for sizes less than 24$"$ should allow for riders of those ages to also ride 24$"$ wheels with older riders, hence the 0-12 (24$"$) group.
All riders in age groups between 0 and 10 will race a 10m Wheel Walk, and 10m Ultimate Wheel, if used (instead of 30m).

\subsection{Finals}
At NAUCC, a `final' must be held for each of the following races: 100m, 400m, 800m, One Foot, and Wheel Walk. 
...
The best result in a final determines the male or female Champion for that discipline (North American Champion in the case of NAUCC).
...
\section{Safety Gear}
Riders must wear shoes, kneepads, helmets and gloves (definitions in chapter \ref{chap:general_definitions}).
...
It is highly recommended that for larger events (like NAUCC) this period be extended to 60 minutes.
...
The following races: 100m, 400m, 800m, One Foot, Wheel Walk, and IUF Slalom, are to be part of every NAUCC.
...
Highest total points score is the North American Champion; one each for male and female.
...
These races should be part of every NAUCC:
