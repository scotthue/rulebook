...
A rider can be asked to show their status via legal government ID or visa if the organizers have \textit{strong reason} to doubt their declared status.
...
This applies for both age group and expert results.
