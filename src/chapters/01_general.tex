...
\begin{itemize}
  ...
  \item Other Racing: Road, specialty/novelty races
  \item Team Games: Unicycle Hockey, Unicycle Basketball
  \item Field events: Long Jump, High Jump, Gliding/Coasting
  \item Non-competition events: workshops, fun games, sightseeing rides, muni rides.
  \item Artistic events: Freestyle, Standard Skill, Flatland, Street
  \item Muni: Cross Country, Orienteering, Uphill, Downhill, Trials
\end{itemize}
