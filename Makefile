...
rulebook: ## The most basic option: Creates the USA Rulebook with the current branch name amended to the filename.
...
# make diff
#
# output: pdf/usa-rulebook-<version>-diff-<branch>.pdf
#
